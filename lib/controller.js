...
var controllerWith = function(code){
	...
	controllerCode += 'var bullets = arguments[5]; '
...
Controller.prototype.control = function(fighter, logger, context, time, state, asteroids, bullets){
	if (!fighter){return};
	try {
		var recorder = new Recorder();
		this.code.call(recorder, logger, context, time, state, asteroids, bullets);
